...
export default {
  ...
  component: BlogsPage,
} as ComponentMeta<typeof BlogsPage>;
...
export const Normal: ComponentStory<typeof BlogsPage> = () => (
  <BlogsPage blogs={blogs} totalCount={20} />
);
export const NoPagination: ComponentStory<typeof BlogsPage> = () => (
  <BlogsPage blogs={blogs} totalCount={4} />
);
